            ...
            else
            {
                using (var db = dbFactory.Open())
                {
                    ...
                    if (!roles.IsEmpty())
                    {
                        ...
                        var enumerable = userRoles.Where(x => x.Role != null).Select(x => x.Role);
                        var roleSet = Enumerable.ToHashSet(enumerable);
                    ...
                    if (!permissions.IsEmpty())
                    {
                        var enumerable = userRoles.Where(x => x.Permission != null).Select(x => x.Permission);
                        var permissionSet = Enumerable.ToHashSet(enumerable); ;
