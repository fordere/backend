...
namespace forderebackend.ServiceInterface.LeagueExecution.Standings.OrderRules
{
    public class MatchNotPlayedOrderRule : IOrderRule
    {
        public int Compare(TableEntry x, TableEntry y)
        {
            ...
            if (x.GamesNotPlayed > StandingsCalculator.MaxNumberOfNotPlayedMatches &&
                y.GamesNotPlayed > StandingsCalculator.MaxNumberOfNotPlayedMatches) return 0;
            ...
            if (x.GamesNotPlayed > StandingsCalculator.MaxNumberOfNotPlayedMatches &&
                y.GamesNotPlayed <= StandingsCalculator.MaxNumberOfNotPlayedMatches) return -1;
